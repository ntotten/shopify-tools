...
var urlFormat = "https://%s:%s@nhbooks.myshopify.com/admin/%s";
...
var loadProducts = function(page, callback) {
  ...
  var url = util.format(urlFormat, config.api_key, config.password, "products.json?fields=id,variants&page=" + page + "&limit=" + limit);
